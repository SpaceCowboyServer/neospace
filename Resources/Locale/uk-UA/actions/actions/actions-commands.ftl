...
upgradeaction-command-help = Використання: upgradeaction <entityUid> [рівень]upgradeaction-command-need-one-argument = upgradeaction має принаймні один аргумент - сутність дії uid. Другим необов'язковим аргументом є вказаний рівень.
