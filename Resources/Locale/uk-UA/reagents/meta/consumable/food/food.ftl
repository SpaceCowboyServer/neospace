reagent-name-nutriment = нутрієнт
reagent-desc-nutriment = Усі вітаміни, мінерали та вуглеводи, необхідні організму, у чистому вигляді.

reagent-name-glucose = глюкоза
reagent-desc-glucose = Простий цукор, що міститься в багатьох продуктах.
