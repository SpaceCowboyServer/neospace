...
# Verbs
signal-linking-verb-text-link-default = Зв'язати порти за замовчуванням
signal-linking-verb-success = Підключено всі посилання {$machine} за замовчуванням.
signal-linking-verb-fail = Не вдалося підключити всі посилання {$machine} за замовчуванням.
