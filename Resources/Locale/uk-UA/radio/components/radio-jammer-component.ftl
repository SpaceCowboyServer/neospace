...
radio-jammer-component-set-message-low = Зараз глушилка працює на низькій потужності.

radio-jammer-component-switch-setting = Перемикач рівня потужності встановлено у положення "[color=yellow]{$powerLevel}[/color]".