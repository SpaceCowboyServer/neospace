...
credits-window-attributions-tab = Автори
...
credits-window-attributions-directory = [color=white]Директорія:[/color] {$directory}
credits-window-attributions-files = [color=white]Файли:[/color] {$files}
credits-window-attributions-copyright = [color=white]Авторське право:[/color] {$copyright}
