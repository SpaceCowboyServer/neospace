...
admin-ui-panic-bunker-count-deadminned-admins = Порахувати Деадмінів
admin-ui-panic-bunker-count-deadminned-admins-tooltip = Підраховуйте адміністраторів у деадміні при автоматичному ввімкненні та вимкненні аварійного бункера.

admin-ui-panic-bunker-show-reason = Показати Причину
admin-ui-panic-bunker-show-reason-tooltip = Показати користувачеві, чому він був заблокований у бункері тривоги.

admin-ui-panic-bunker-min-account-age = Мін. Вік Акаунту
