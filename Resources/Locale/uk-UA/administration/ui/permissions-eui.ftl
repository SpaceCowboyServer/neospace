...
permissions-eui-menu-admin-ranks-tab-title = Ранги Адміністраторів
permissions-eui-edit-admin-window-edit-admin-label = Редагувати адміністратора {$admin}
permissions-eui-edit-admin-window-name-edit-placeholder = Ім'я користувача/ID користувача
permissions-eui-edit-admin-window-title-edit-placeholder = Користувацька назва, залиште порожньою, щоб залишити звичайну назву рангу.
