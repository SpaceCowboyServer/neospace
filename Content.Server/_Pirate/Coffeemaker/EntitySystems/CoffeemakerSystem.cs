...
public sealed partial class CoffeemakerSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<CoffeepotComponent, SolutionChangedEvent>(OnCoffeepotSolutionChanged);
    ...
    private void OnCoffeepotSolutionChanged(Entity<CoffeepotComponent> ent, ref SolutionChangedEvent args)
    {
